...
namespace GestionPioches
{
    public class LesSkins
    {
        ...
        public void init()
        {
            ...
            //s1.Photo = Image.FromFile("~/images/image1.jpg");
            Liste.Add(s1);
           ...
           // s2.Photo = Image.FromFile("~/images/image2.jpg");
            Liste.Add(s2);
            ...
            //s3.Photo = Image.FromFile("~/images/image3.jpg");
            Liste.Add(s3);
            ...
            //s4.Photo =  Image.FromFile("~/images/image4.jpg");
            Liste.Add(s4);
