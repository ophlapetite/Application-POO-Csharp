   ...
   public  abstract class Equipement : IEquatable<Equipement>, IComparable<Equipement> // implémentation de deux interfaces
    {
        ...
        private string photo;                            // déclaration d'un attribut de type Image représentant la photo de l'équipement
        ...
        public override string ToString()
        {
            ...
            s += "\n Rareté : " + this.RareteS;
            s += "\n Prix : " + this.prix;
            s += "\n Date de parution : " + this.dateParution.ToString("dd/MM/yyyy");
            return s;
